...
# -------------------------- 基础配置（仅需修改这里） --------------------------
# 路径配置（和汉字笔画训练集一致）
eeg_data_root = r'D:\Handwriting_Imagery_Raw_Dara\CCS-SV-HI-EEG_BIDS'
event_data_root = r'D:\Handwriting_Imagery_Raw_Dara\CCS_HI_Event_Txt'
save_path = r'D:\EEG_HandWriting_Project_Code\FineSTAN\dataset\bci_handwriting_data'
...
event_files = [
    ...
    if (f.startswith(f'A0{sub_id}E') or f.startswith(f'A{sub_id}E'))  # 匹配A01E/A1E
    and ('_Event' in f)
]
