...
data_files = ['A0' + str(i) + 'E.bdf' for i in range(14, 15)]  # only one T/E.bdf files
...
filtered_files = [file for file in files if file.endswith('A14E_Event.txt')]
data_files_bdf = [file for file in files if file.endswith('A14E.bdf')]
index = 0
# create MNE Event
